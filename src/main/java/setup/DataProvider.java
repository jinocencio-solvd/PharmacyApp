...
public class DataProvider {
    ...
    public static Customer[] predefinedCustomers() {
        return new Customer[]{
            new Customer("(patient) Todd Daver", "555-7890", addresses[5]),
            new Customer("(patient) Saul Johnson", "555-2345", addresses[6]),
            new Customer("(patient) Saul II Johnson", "555-2345", addresses[6]),
            new Customer("(patient) John Smith", "555-1234", addresses[0]),
            new Customer("(patient) Jane Doe", "555-5678", addresses[1]),
            new Customer("(patient) Michael Brown", "555-1111", addresses[2]),
            new Customer("(patient) Emily Davis", "555-2222", addresses[3]),
            new Customer("(patient) Daniel Johnson", "555-3333", addresses[4]),
            new Customer("(patient) Olivia Wilson", "555-4444", addresses[5]),
            new Customer("(patient) William Lee", "555-5555", addresses[6]),
            new Customer("(patient) Sophia Moore", "555-6666", addresses[0]),
            new Customer("(patient) James Anderson", "555-7777", addresses[1]),
            new Customer("(patient) Isabella Thompson", "555-8888", addresses[2]),
            new Customer("(patient) Benjamin Martinez", "555-9999", addresses[3]),
            new Customer("(patient) Mia Garcia", "555-0000", addresses[4])
        };
    }
